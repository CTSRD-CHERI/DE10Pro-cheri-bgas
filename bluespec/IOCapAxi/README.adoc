...
* crypto-cap-experiments (my private repository) rust_caps_c Rust crate, compiled to a static .a library. This is provided as a .a file, that has only been build for x86-64 Linux.