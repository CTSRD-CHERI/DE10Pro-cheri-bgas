...
int main(int argc, char** argv) {
    return tb_main(
        {
            new WriteAndEnableKeyTest<VmkIOCapAxi_KeyManager2_RefCountPipe_TwoValve_Tb>(),
            new WriteAndEnableKeyTest_EventBased<VmkIOCapAxi_KeyManager2_RefCountPipe_TwoValve_Tb>(),
            new InvalidationEpochs<VmkIOCapAxi_KeyManager2_RefCountPipe_TwoValve_Tb>(),
            new OneKeyRequestPerCycle<VmkIOCapAxi_KeyManager2_RefCountPipe_TwoValve_Tb>(),
            new PerformanceCounting<VmkIOCapAxi_KeyManager2_RefCountPipe_TwoValve_Tb>(),
        },
        argc, argv
    );
}